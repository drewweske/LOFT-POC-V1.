...
export function buildWorld(scene,pin){
  ...
  function bunker(x,z,sx,sz,seed){
    ...
    const g=new THREE.ShapeGeometry(sh);g.rotateX(-Math.PI/2);const b=new THREE.Mesh(g,mat(COLORS.sand,.99));b.position.set(x,terrainHeight(x,z)+.075,z);b.receiveShadow=true;world.add(b);
  }
