...
// can run it to rest. Aim is explicit; ShotIntent.shotSeed is the sole production
...
import {dispersionFromShotSeed} from './seedContract.js';
...
export function launchShotPhysics(physics,{metrics,c,L,lie,position,aimYaw,dispersion,dispersionSource}){
  ...
  // Optional raw scalar is a test seam; production supplies the frozen seed mapping.
...
// and shotSeed. No raw dispersion authority or equipment/level/environment lookup.
