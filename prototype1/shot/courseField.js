// Native Coastal Ridge field, moved without numerical edits. Cache/scratch state
...
const SURFACE_LIFT=Object.freeze({
...
*/
function sampleTerrain(x,z,out={}){
  if(x<TERRAIN_GRID.xMin||x>TERRAIN_GRID.xMax||z<TERRAIN_GRID.zMin||z>TERRAIN_GRID.zMax){
    const e=.40;
...
function terrainContactY(x,z,radius=0){
...
function sweepTerrainSegment(a,b,radius=0){
...
function greenSurfaceHeight(center,x,z){
...
return {
  SURFACE_LIFT,BUNKERS,WATER_LEVEL,fairwayProfile,terrainHeight,sampleTerrain,terrainContactY,sweepTerrainSegment,greenSurfaceHeight,waterAt,courseSurfaceAt,
  FIRST_CUT_WIDTH,fairwaySignedDistance,valueNoise,fbm,bunkerMetric,TERRAIN_GRID,GRID_DX,GRID_DZ,GRID_W,gridSample,gridNormal,bunkerAt,greenMetrics,coastEdge,teeMetricAt
};
}
